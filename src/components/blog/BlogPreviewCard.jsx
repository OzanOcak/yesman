    ...
    <>
      <VStack as={LinkBox} align="start" spacing="1rem" mb="2rem">
        ...
        <Text noOfLines={3}>
          ...
          doloremque lorem velit, adipisci. Fugit quas consequuntur aliquid
          possimus doloremque lorem velit, adipisci. Fugit quas consequuntur
          aliquid possimus possimus Libero
        </Text>
